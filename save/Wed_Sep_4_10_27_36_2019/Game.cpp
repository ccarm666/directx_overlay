...
//	if (!backGround->Initialize(gDevice->device, "mycomm.png", 1600, 900)) return false;
	...
	if (!faces[1]->Initialize(gDevice->device, "face1.png", (int)(face_scale * 50), (int)(face_scale * 58)))  return false;
	if (!faces[2]->Initialize(gDevice->device, "face2.png", (int)(face_scale * 48), (int)(face_scale * 58)))  return false;
	if (!faces[3]->Initialize(gDevice->device, "face3.png", (int)(face_scale * 50), (int)(face_scale * 58)))  return false;
	if (!faces[4]->Initialize(gDevice->device, "face4.png", (int)(face_scale * 51), (int)(face_scale * 58)))  return false;
	if (!faces[5]->Initialize(gDevice->device, "face5.png", (int)(face_scale * 52), (int)(face_scale * 58)))  return false;
	if (!faces[6]->Initialize(gDevice->device, "face6.png", (int)(face_scale * 51), (int)(face_scale * 57)))  return false;
