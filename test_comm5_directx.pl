...
# my $img = screenshot();
sleep(1);
 $parm_file = &get_closest_parm( 28, $parm_dir );
...
print "about to run nircmd savescreenshotwin\n";
 `c:\\WINDOWS\\nircmd.exe  savescreenshotwin "mycomm.png"`;
print "just ran nircmd savescreenshotwin\n"; 
 &print_where();
...
print "package=$package, filename=$filename, line=$line, subr=$subr, args=$has_args\n";
}
